    ...
    <form onSubmit={handleSubmit} className="space-y-8">
      <div>
        ...
        <div className="relative mt-4">
          ...
          <input
            ...
            className="w-full rounded-lg border border-navy-200 py-2.5 pl-8 pr-4"
          />
        </div>
      </div>
      ...
      <div className="rounded-xl border border-navy-200 p-6">
        ...
        <input
          ...
          className="mb-4 w-full rounded-lg border border-navy-200 px-4 py-2.5"
        />
        <div className="grid gap-4 sm:grid-cols-2">
          <input
            required
            ...
            className="rounded-lg border border-navy-200 px-4 py-2.5 sm:col-span-2"
