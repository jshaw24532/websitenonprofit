...
import { getDonationMethodsForOrg } from "@/lib/organizations";
...
interface OrgDonationMethodCardsProps {
  orgSlug: string;
  activeId?: string;
}

export default function OrgDonationMethodCards({
  orgSlug,
  activeId,
}: OrgDonationMethodCardsProps) {
  const methods = getDonationMethodsForOrg(orgSlug);
