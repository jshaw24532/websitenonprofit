  ...
  return (
    <>
      <PageHero
        ...
        description="Plug in your project budget and see instant savings. Our fixed model delivers up to 65% cost reduction for government agencies—with a transparent 35% philanthropic service fee applied only to gross savings."
            ...
            <div className="mb-8 flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
              <div>
                ...
                <p className="text-lead mt-3 max-w-2xl">
                  Enter your total project budget. Savings (65%) and service fee
                  (35% of savings) are fixed—results update instantly.
                </p>
              </div>
              <Link
