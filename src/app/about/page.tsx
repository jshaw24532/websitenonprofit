  ...
  return (
    <>
      <PageHero
        ...
        description="A 501(c)(3) nonprofit that saves governments up to 63% on infrastructure at zero upfront cost—and reinvests in mobile community food outreach."
      />
